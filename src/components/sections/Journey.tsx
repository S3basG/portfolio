      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="h-full bg-zinc-50 dark:bg-zinc-900 border-2 border-zinc-200 dark:border-zinc-800 p-8">
              ...
              <div className="space-y-4 border-t-2 border-zinc-200 dark:border-zinc-800 pt-6">
                ...
                <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                  Projects are documented to preserve technical decisions, design tradeoffs, and lessons learned—creating a knowledge archive for future reference.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            {timeline.filter(t => t.type === 'extracurricular').map((item) => (
              <div key={item.id} className="relative pl-8 border-l-2 border-purple-600 dark:border-purple-400">
                <div className="absolute -left-[5px] top-0 w-2 h-2 bg-purple-600 dark:bg-purple-400 rounded-full"></div>
                <div className="pb-8">
                  <p className="font-mono text-xs text-zinc-500 mb-2">{item.year}</p>
                  <h4 className="text-lg font-bold text-zinc-900 dark:text-white mb-1">{item.role}</h4>
                  <p className="text-sm text-purple-600 dark:text-purple-400 font-medium mb-2">{item.organization}</p>
